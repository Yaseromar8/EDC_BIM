...
| **C7** | No hay copia de los ficheros; la mayoría de los bytes no los conoce nadie | bucket sin versionado ni copia; sin conciliación BD↔almacén | **ABIERTO** | 721 objetos / 3,95 GB sin correspondencia |
...
| **N13** | El recolector de fotos huérfanas no borra nada (argumentos invertidos) | `tracking.py:296` | **ABIERTO** | arreglarlo lo *enciende*: decisión pendiente |
