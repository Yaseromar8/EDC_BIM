...
| 12 | **Identity & Access UX** | ACC account/project admin UI | Procore Directory UX | La escalera PERSONA→ENTIDAD→PROYECTOS→EMPRESA/FUNCIÓN→ADMINISTRACIÓN→PERMISOS, **sin un “rol” gigante** | **PARCIAL** | LoginScreen (559 líneas, con invitación/reset/2FA) · Participantes · RolDeMiembro | **ABIERTO AHORA** — es la fase siguiente | **Doc 55** (diseño; no implementar) |
