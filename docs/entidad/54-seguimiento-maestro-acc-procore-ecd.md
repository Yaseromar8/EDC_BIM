...
| 12 | **Identity & Access UX** | ACC account/project admin UI | Procore Directory UX | La escalera PERSONA→ENTIDAD→PROYECTOS→EMPRESA/FUNCIÓN→ADMINISTRACIÓN→PERMISOS, **sin un “rol” gigante** | **PARCIAL** — **diseño CERRADO DEFINITIVAMENTE** (docs 55–61) | LoginScreen (559 líneas, con invitación/reset/2FA) · Participantes · RolDeMiembro · diseño: `invitacion_gen`, `activated_at`, invariante sesión⇒activada | — (el diseño ya no está abierto) | **Implementación POST-WINDOW** en el orden de la adenda 57 §4 con las notas 59/60/61; G4b aparte |
