...
### Unidad ARCHIVOS · PDF PESADO · P1 VISTA PREVIA LEGIBLE — PROTOTIPO ACEPTADO E INTEGRADO EN BACKEND, SIN COMMIT, 17-sep
...
TESTS PENDIENTES:     producción (necesita el backend y una sesión del propietario); `004122`; Render.
...
NEXT EXACT ACTION:    esperar la decisión del propietario sobre el arreglo de la puerta multipágina (1 línea, sin commit). No empujar ni desplegar.
DO NOT TOUCH:         mosaicos/tiles, motor PDF, infraestructura, migraciones, zoom ×3–×8, lote masivo de históricos; y el camino del lector cuando no hay vista previa.
COMMIT/HEAD REF:      `b82c4e6` sobre `fe84d32`; sin push ni despliegue. Encima, sin commitear: la línea de la puerta multipágina.
