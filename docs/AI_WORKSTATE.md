...
### Unidad UX · UI POLISH · F4 BARRA LATERAL — UN COMMIT AUTORIZADO, SIN PUSH NI DESPLIEGUE, 17-sep
...
PENDIENTE:            1) push y despliegue NO autorizados. 2) F1 sigue sin autorizar. 3) «selected-hover» (activa con el puntero encima) queda para el programa de tokens; no se corrige en F4. 4) Mi Trabajo, fuera de esta entrega.
...
COMMIT/HEAD REF:      `fix(ui-polish/f4): …` sobre 4511e8f; sin push
