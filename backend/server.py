...
def get_inventory_schema():
    from inventory_http import inventory_schema_request
    return inventory_schema_request()
...
def get_inventory(_obra_forzada=None):
    from inventory_http import read_inventory_request
    return read_inventory_request(forced_scope=_obra_forzada)
...
def get_inventory_version(_obra_forzada=None):
    from inventory_http import inventory_version_request
    return inventory_version_request(forced_scope=_obra_forzada)


@app.route('/api/inventory', methods=['PATCH'])
def update_inventory():
    from inventory_http import patch_inventory_request
    return patch_inventory_request(bulk=False)

@app.route('/api/inventory/bulk', methods=['PATCH'])
def bulk_update_inventory():
    from inventory_http import patch_inventory_request
    return patch_inventory_request(bulk=True)
